...
<footer >
  ...
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #089cac;">
   ...
   <!-- termina navbar-->
  <div class="portada">
    <h1 class="display-4 fw-bolder">Bienvenido a Uam Lost & Found</h1>
    <p class="lead fw-semibold">Encuentra libros perdidos y olvidados en nuestra biblioteca.</p>
  </div>
  <div class="container mt-5">
    <div class="d-flex row flex-wrap " style="">
      @foreach ($books as $book)
        <div class="col-sm  " style="min-width:30%; margin:5px">
          <div class="card">
